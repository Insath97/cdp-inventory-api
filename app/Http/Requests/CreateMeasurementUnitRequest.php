...
class CreateMeasurementUnitRequest extends BaseFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'nullable|string|max:255|unique:measurement_units',
            'short_code' => 'required|string|max:50|unique:measurement_units',
