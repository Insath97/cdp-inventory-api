...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        // Handle UnauthorizedHttpException for JWT token expiration
        ...
        // Global safety net: hide raw exception messages from API clients in production.
        // Controllers that use plain $th->getMessage() without the debug guard are covered here.
